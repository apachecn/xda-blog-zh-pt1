...
> 原文：<https://www.xda-developers.com/android-platform-stats-nov-2014/>
...
在壁纸和风格应用程序(又名壁纸选择器)中，有一个新的“主题图标”切换。该切换显示了在测试 2 中隐藏的功能[。当您启用此选项时，大多数谷歌应用程序的图标将跟随您的系统主题。不是每个谷歌应用都受到这种影响——在我们的设备上，聊天、查找我的设备、玩游戏和任务的图标不是动态主题——但绝大多数谷歌应用都受到这种影响的支持。](https://www.xda-developers.com/android-12-beta-2-features/#android12beta2_icontheming)
