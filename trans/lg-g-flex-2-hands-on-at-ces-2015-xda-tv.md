...
> 原文：<https://www.xda-developers.com/lg-g-flex-2-hands-on-at-ces-2015-xda-tv/>
...
三星还对软件进行了微调，以进一步利用更大的显示屏。我们最喜欢的新功能之一是任务栏，它是一个沿着手机底部的栏，列出了你最常使用或最后使用的应用程序。从这个栏中，您可以快速浏览应用程序，而无需跳回主屏幕。当然，如果您不需要或不想分散注意力，您可以取消这个酒吧。
