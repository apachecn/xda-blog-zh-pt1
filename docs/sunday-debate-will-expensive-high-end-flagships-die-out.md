...
> 原文：<https://www.xda-developers.com/sunday-debate-will-expensive-high-end-flagships-die-out/>
...
新的相机允许银河 S23 Ultra 对微光摄影做进一步的改进，因为普通的装箱照片包含的图像信息几乎是 S22 Ultra 主相机拍摄的两倍。您也可以拍摄完整的 200 兆像素，之后您可以大幅裁剪，不会像其他手机相机照片那样丢失太多细节。虽然后面的其他相机——一对 10 兆像素的变焦镜头和 12 兆像素的超宽相机——与 S22 超宽相机保持不变，但三星改进的计算摄影加上高通骁龙 8 Gen 2 芯片中较新的 ISP，使得照片的曝光度和颜色都有所提高。
