...
> 原文：<https://www.xda-developers.com/curb-your-social-networking-addiction-with-socials-addict/>
...
如果你同时关心安全和隐私，信号是你最好的选择。它使用与 WhatsApp 相同的加密协议，因此您可以获得相同的端到端加密。然而，Signal 得到了一个非营利基金会的支持，而不是一家“大型科技”公司，他们也有一个侵入性较小的隐私政策。如果这是你感兴趣的东西，那绝对值得一看，尽管你也必须记住，它的用户比 Telegram 或 WhatsApp 少得多。

Textra 无疑是安卓系统中最好、最可靠的短信应用程序之一。所以，如果你经常发短信，那么这是一款[优秀的消息应用程序](https://www.xda-developers.com/best-text-messaging-apps-android/)。它具有高度的可定制性，并带有许多可定制的主题。在功能方面，您可以获得聊天头像、定时消息、复制部分消息的功能、群消息和黑名单。Textra 比原始设备制造商提供的许多其他短信应用程序要好得多，所以如果你想更换手机上的库存短信应用程序，请尝试一下。
