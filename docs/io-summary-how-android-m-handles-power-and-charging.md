...
> 原文：<https://www.xda-developers.com/io-summary-how-android-m-handles-power-and-charging/>
...
为数据提供一个单独的分区将使操作系统更容易保证数据的安全，同时仍能保证数据可用于系统级功能。这意味着上述功能的敏感音频和语言处理将专门在您的设备上进行。
