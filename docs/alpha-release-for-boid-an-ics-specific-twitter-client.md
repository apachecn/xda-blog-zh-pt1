...
> 原文：<https://www.xda-developers.com/alpha-release-for-boid-an-ics-specific-twitter-client/>
...
谷歌 Play 商店不乏音乐和视频流媒体应用程序，但我们想强调一些独特的选项供您查看。这些是我们目前选择的音频和视频应用的三大选择。
...
[Spark](https://play.google.com/store/apps/details?id=com.readdle.spark) 是 T2 最好的电子邮件应用程序之一，有很多非常棒的功能。它可以智能地为您的电子邮件排定优先级，智能地处理通知，甚至允许您与您的团队协作处理电子邮件。这个特殊的电子邮件客户端的一些其他值得注意的功能包括智能搜索、快速回复、电子邮件调度、打瞌睡的电子邮件等等。
