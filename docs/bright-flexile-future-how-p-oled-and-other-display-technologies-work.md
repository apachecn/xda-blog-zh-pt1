...
> 原文：<https://www.xda-developers.com/bright-flexile-future-how-p-oled-and-other-display-technologies-work/>
...
Evernote 是一款功能强大的笔记应用程序，可帮助您跨不同平台整理重要笔记。通过这个应用程序，您可以保存各种注释，包括文本、图像、音频，甚至是它们的混合，并使它们可以在多个平台上使用。Evernote 的一大优势是它采用了光学字符识别技术，可以对图像中的文本进行搜索。如果您碰巧将大量图像保存为笔记，并且需要将其中的文本复制到设备中，这将非常方便。
