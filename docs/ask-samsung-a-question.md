...
> 原文：<https://www.xda-developers.com/ask-samsung-a-question/>
...
无论您想要一个更小或更实惠的旗舰，银河 S22 似乎勾选了所有重要的框。
...
Fold 4 还将铰链区域缩小了几毫米，因此折叠后体积更小，并为屏幕提供了宝贵的额外空间，因此内外显示屏都比去年略宽。当使用折叠形式的折叠 4 时，这种改进最为明显。它仍然是一个细长的糖果棒形状，但屏幕感觉不那么局促，键入。
