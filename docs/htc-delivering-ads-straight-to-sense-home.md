...
> 原文：<https://www.xda-developers.com/htc-delivering-ads-straight-to-sense-home/>
...
如果你想要真正的谷歌安卓体验，像素 7 系列是你需要的手机。我们在此列出了标准的像素 7，因为我们仍然认为它是最适合大多数人的像素手机。对于那些已经使用过像素 6 系列的人来说，像素 7 系列的体验不会有太大的不同——安卓 13 与 Material You 是一个改进年，而不是一个重大的检修年。
