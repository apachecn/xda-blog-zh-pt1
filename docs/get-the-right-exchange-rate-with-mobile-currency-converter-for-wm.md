...
> 原文：<https://www.xda-developers.com/get-the-right-exchange-rate-with-mobile-currency-converter-for-wm/>
...
然后是 Windows Phone。粉丝们嘲笑和嘲笑的平台灭绝了。但是，当您再看一看时，您会注意到这个用户界面一点也没有老化。事实上，它看起来更像一个可以在 2021 年使用的 UX。
