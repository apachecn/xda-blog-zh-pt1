...
> 原文：<https://www.xda-developers.com/froyo-arrives-on-the-htc-droid-incredible/>
...
三星 Galaxy Z Flip 4 是目前市场上最实惠、最时尚的折叠式手机。
...
所谓的“材料你”是谷歌让像素安卓体验感觉更个性化的方式——用你的主屏幕壁纸和创建一个调色板来给系统界面上色。在整个用户界面中，都有古怪的谷歌触摸，比如不同大小和形状的按钮。
