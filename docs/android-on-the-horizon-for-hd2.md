...
> 原文：<https://www.xda-developers.com/android-on-the-horizon-for-hd2/>
...
在 Android 12 之前，扫描附近蓝牙或 Wi-Fi 设备的能力是与 Android 更广泛的“位置”许可联系在一起的。这种情况的原因是有道理的。您可以通过推断附近或当前连接的蓝牙设备或无线网络来跟踪设备。因此，即使一个应用程序只扫描蓝牙设备，不利用全球定位系统或其他跟踪技术，它仍然需要相同的位置权限。
