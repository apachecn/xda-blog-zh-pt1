...
> 原文：<https://www.xda-developers.com/miui-file-explorer-ported-to-other-roms-acquires-root/>
...
对于其他索尼 Xperia 设备，请查看我们论坛的[索尼部分](https://forum.xda-developers.com/c/sony.12026/)。你应该可以在设备分论坛中找到类似的微调指南。你也可以遵循本教程中的通用生根指南。
...
在这种情况下，您必须首先提取有效载荷. bin 文件，然后使用社区开发的有效载荷. bin 解包器从中获取 boot.img。我们强烈建议您选择 Go 中的[提取器，因为它是跨平台的，并且已经由](https://forum.xda-developers.com/t/tool-a-quick-android-ota-payload-dumper.4173271/)[积极开发](https://github.com/ssut/payload-dumper-go)。
