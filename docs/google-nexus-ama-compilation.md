...
> 原文：<https://www.xda-developers.com/google-nexus-ama-compilation/>
...
您会看到一个漂亮的 6.4 英寸有机发光二极管显示屏，具有 FHD+分辨率和 90Hz 刷新率。该面板没有像素 6 专业版那么亮，也不支持 LTPO 技术的动态刷新率。但是小屏幕尺寸和 1080p 的分辨率意味着 Pixel 6 的显示屏不像 Pixel 6 Pro 的 QHD+面板那样耗电。在 500 尼特，屏幕并不那么明亮，但足够户外使用。
