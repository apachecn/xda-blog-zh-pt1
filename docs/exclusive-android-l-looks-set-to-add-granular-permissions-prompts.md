...
> 原文：<https://www.xda-developers.com/exclusive-android-l-looks-set-to-add-granular-permissions-prompts/>
...
如前所述，开发者预览 1.1 更多的是一个错误修复更新。除了解决初始版本中存在的一些错误之外，在功能方面似乎没有任何重大变化。这种构建也提升了安卓的安全补丁水平。更多信息，请继续阅读本文。
