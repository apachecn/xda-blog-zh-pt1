...
> 原文：<https://www.xda-developers.com/htc-twitter-qa-compilation/>
...
好吧，所以谷歌像素 7 在技术上不是“库存”安卓，因为库存安卓是最基本的开源安卓(AOSP)，通常在一些不知名品牌的入门级低价手机中看到。相反，像素 7 运行的是谷歌修改版的安卓 13，但因为这是谷歌眼中的安卓，我们认为，这使得像素化的体验比普通的旧安卓更能代表“安卓应该是什么样子”。
