...
> 原文：<https://www.xda-developers.com/xda-developers-exclusive-first-leaked-pics-of-htc-mazaa/>
...
像素 6a 输给像素 6 的地方是在主相机传感器中:6a 使用较旧的 12.2 兆像素索尼 IMX 传感器，而像素 6 使用较新的 GN1 传感器和较大的图像传感器。现在，虽然谷歌的计算摄影技术非常好，像素 6a 仍然可以产生漂亮的图像，但是像素 6 的传感器更大了一点。你在镜头中得到更多的景深，并且有更多的光线信息供张量使用。
...
听着，我们知道在过去的一年里，自从一加和 OPPO 最终承认是同一家公司，并且加氧开始看起来越来越像 OPPO 的 ColorOS，一加的加氧已经失去了一点它的特性。但事情是这样的——ColorOS 是好的，这个运行在一加 10 Pro 中的“着色”版本的 ColorOS 仍然是世界上最灵活、最流畅的软件之一。
...
去年，谷歌凭借像素 6 专业版(至少在最佳定点拍摄类别的*)夺回了桂冠，因为它最终升级了相机硬件以跟上竞争。今年的[像素 7 专业版](https://www.xda-developers.com/google-pixel-7-pro-review/)进一步完善了像素 6 专业版系统。*
