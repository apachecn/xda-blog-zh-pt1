...
> 原文：<https://www.xda-developers.com/and-it-keeps-going-and-going-sense-4-rom-released-for-hd2/>
...
你是一个普通的安卓发烧友，并寻找一个像素式的只读存储器，也提供一些有用的用户界面/UX 定制？看看 Evolution X 项目。该光盘附带预装的谷歌应用程序和像素的好东西，并具有一些定制功能，如状态栏可见性切换和游戏模式快速设置平铺。
