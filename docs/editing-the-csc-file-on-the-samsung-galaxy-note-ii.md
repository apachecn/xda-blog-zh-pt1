...
> 原文：<https://www.xda-developers.com/editing-the-csc-file-on-the-samsung-galaxy-note-ii/>
...
如果您对 S-Pen 没有太大的用处，而是想节省一点钱，那么 [Galaxy S22 Plus](https://www.xda-developers.com/samsung-galaxy-s22-plus-review/) 是一个很好的替代选择。你仍然可以得到一个华丽的 120 赫兹的 AMOLED 屏幕，一个非常好的摄像系统，高通骁龙 8 代 1 SoC，一个玻璃和铝的结构，以及三星的抛光和多功能软件，可以说可以做更多的事情，而不仅仅是库存的 Android。例如，你可以在 OneUI 的浮动窗口中打开应用程序，这在 Android 系统中是无法实现的。加上三星的 DeX，使得 Galaxy S22 Plus 成为比像素更好的多任务处理设备。
