...
> 原文：<https://www.xda-developers.com/control-your-appliances-with-your-android-device/>
...
如果您更喜欢手动将电子书下载到手机上，而不是依靠 Kindle 之类的服务，那么您可能会想看看锂。这个应用程序可以让你阅读本地存储在手机上的电子书。它是基于材料设计指南构建的，允许您阅读保存在 EPUB 文件中的电子书。它会自动检测您正在阅读的电子书，允许您高亮显示、为书籍添加注释、更改为夜间/深褐色主题以方便阅读等。它没有广告，这对不间断的阅读体验很好。您也可以选择支付一次性费用来购买该应用的专业版，并获得一些额外的功能、定制主题、更多高亮颜色等。
