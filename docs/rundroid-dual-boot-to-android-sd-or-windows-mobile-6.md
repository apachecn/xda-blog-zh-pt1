...
> 原文：<https://www.xda-developers.com/rundroid-dual-boot-to-android-sd-or-windows-mobile-6/>
...
虽然这里的一对 12MP 相机在硬件上并不令人惊讶，但三星的计算摄影非常聪明，所以它将帮助用人工智能的诡计来补偿旧的硬件，以产生通常充满活力和细节的镜头。当然，有了 Flex 模式，Flip 4 也可以用很多创造性的方式拍摄。总的来说，翻盖 4 是对已经很好的小型可折叠手机的一次迭代改进。
