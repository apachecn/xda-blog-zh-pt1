...
> 原文：<https://www.xda-developers.com/windows-phone-7-series-media-gallery/>
...
拥有一台功能强大的 50MP 主相机和一个相对较大的图像传感器，一个可以使用传感器内裁剪产生几乎 10 倍光学变焦的 5 倍 Periscope 变倍镜头，以及一台横扫一切的超宽相机，Google Pixel 7 Pro 拥有一个非常强大的摄像系统。但可以说它之所以是最好的，是因为它背后有一个大脑:谷歌张量 G2。谷歌的第二代硅利用了谷歌强大的机器学习能力，可以检测镜头拍摄的图像数据，进而生成动态范围、细节和清晰度都非常出色的图像。
