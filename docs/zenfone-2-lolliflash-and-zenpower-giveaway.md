...
> 原文：<https://www.xda-developers.com/zenfone-2-lolliflash-and-zenpower-giveaway/>
...
因为 ZenFone 8 没有像它的大兄弟一样的翻盖式相机，所以你不能从后面录音切换到前面录音。这是 ZenFone 翻盖式相机最好的部分之一，但遗憾的是，为了让 ZenFone 8 尽可能紧凑，它不得不被排除在外。幸运的是，该设备确实具有 ZenFone 已知的许多其他视频记录功能，包括运动跟踪。
