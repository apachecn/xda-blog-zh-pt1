...
> 原文：<https://www.xda-developers.com/t-mobile-galaxy-s6-battery-woes/>
...
[Galaxy A53 5G](https://www.xda-developers.com/samsung-galaxy-a53-5g-hands-on/) 是三星的一款稳健的中档手机，它走捷径以达到更低的价格。有一个塑料建造而不是玻璃，你不会得到很多变焦相机，但这些功能的人在预算会很乐意牺牲，以节省数百美元。相反，三星 Galaxy A53 5G 仍然提供近乎无边框的 120Hz AMOLED 显示屏、功能强大的 Exynos 1280，以及一个以 64MP 射击游戏和 12MP 超宽相机为标题的不错的相机系统(就其价格范围而言)。尤其是主摄像机，已被证明能够在所有照明条件下工作。三星的计算摄影技术足以提升有限的硬件，利用像素宁滨在照片中产生更多的光线和动态范围。超广角相机在细节上可能有点软，但仍然是捕捉全景照片的有用工具。A53 可以录制高达 4K/30 的视频，但在这里需要稳定。相反，在 1080p 拍摄，以获得平滑稳定的镜头。
