...
> 原文：<https://www.xda-developers.com/xplodwild-talks-about-open-source-at-this-years-big-android-bbq-xda-developer-tv/>
...
泄露的安卓 12 版本也暗示了谷歌可能正在展示安卓隐藏的回收站功能。使用 MediaStore API 的应用程序可以利用 Android 11 API 中添加的垃圾功能。垃圾处理在概念上类似于著名的 Windows“回收站”，在该回收站中，文件会从视图中删除，但在永久删除之前仍可在一段时间内恢复。尽管 Android 11 缺乏对这个回收站的全系统视图，但线索表明，可以编辑垃圾文件的应用程序或需要用户同意的应用程序可以显示隐藏的回收站中的项目。
