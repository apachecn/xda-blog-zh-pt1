...
> 原文：<https://www.xda-developers.com/how-to-save-battery-while-running-android-on-hd2-leo/>
...
Android 12 现在会根据手机当前墙纸中使用的颜色，在系统 UI 中自动选择一组相关的调色板。这些颜色将均匀地应用于各个元素，例如锁屏、快速设置、通知面板，甚至是新添加的[自适应小部件](https://www.xda-developers.com/google-android-12-widgets-overhaul/)。
