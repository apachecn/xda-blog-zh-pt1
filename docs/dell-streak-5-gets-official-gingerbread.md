...
> 原文：<https://www.xda-developers.com/dell-streak-5-gets-official-gingerbread/>
...
不幸的是，动态主题化的应用图标列表看起来像是硬编码的。目前还没有第三方应用遵循这一主题，尽管开发者可以在 Material You 库发布后更改自己应用的图标。主题化的应用程序图标也仅显示在主屏幕上，而不会显示在应用程序抽屉、设置或最近使用的应用程序概述中。这当然是一个很棒的特性，但如果你的主屏幕上只有一个图标不符合你的系统主题，而其他图标符合，那就真的很不和谐了。
