...
> 原文：<https://www.xda-developers.com/acta-annihilated-by-europe-fatality/>

所以，您刚刚得到了一部新的安卓手机，可以安装并开始使用了。下一步的工作是下载一些应用程序来充分利用你的新手机。谷歌 Play 商店有数百万的应用和游戏，但并不是所有的都值得考虑。
