...
> 原文：<https://www.xda-developers.com/the-view-on-task-managers-for-android/>
...
这是我们在开发者预览 2 和开发者预览 3 之间的 Android 12 泄漏版本中发现的更令人兴奋的变化之一。这个泄露的版本包含了很多关于一个功能的线索，我们推测这个功能会[自动将应用翻译成本地语言](https://www.xda-developers.com/android-12-app-ui-translation/)。将这些线索拼凑在一起，我们相信该功能将旨在直接翻译应用程序用户界面中的文本，替换内嵌的文本，使翻译更具本土性。
