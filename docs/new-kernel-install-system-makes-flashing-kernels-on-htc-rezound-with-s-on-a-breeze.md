...
> 原文：<https://www.xda-developers.com/new-kernel-install-system-makes-flashing-kernels-on-htc-rezound-with-s-on-a-breeze/>
...
事实上，新的高通芯片应该是为 S23 系列定制的，因为它被命名为“银河骁龙 8 代 2”。然而，根据我们的测试，它主要只是标准芯片的超频版本。这是一个进步，但也许不像名字想象的那么令人惊讶。
