...
> 原文：<https://www.xda-developers.com/x-link-simplfies-transfers-between-android-and-pc/>
...
开发人员预览在很大程度上仍然不稳定，并且它们不是为普通用户设计的。谷歌也保留在这个阶段添加或删除功能的权利，所以如果你在第一次开发者预览中看到一个功能在随后的版本中丢失，不要感到惊讶。开发者预览也仅限于受支持的谷歌像素设备。
