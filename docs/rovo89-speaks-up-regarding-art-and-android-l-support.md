...
> 原文：<https://www.xda-developers.com/rovo89-speaks-up-regarding-art-and-android-l-support/>
...
像素手机上的设备个性化服务应用程序提供了一些漂亮的功能。值得注意的是，该应用程序使用 OCR 从最近的应用程序概述中的任务中提取文本和图像。
