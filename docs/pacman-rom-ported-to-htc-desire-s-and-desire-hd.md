...
> 原文：<https://www.xda-developers.com/pacman-rom-ported-to-htc-desire-s-and-desire-hd/>
...
考虑到三星的 Galaxy S21 和 S22 Ultra 在 2021 年和 2022 年几乎都占据了这个位置，三星不需要为 Galaxy S23 Ultra 做太多事情就能在发布后立即获得这个位置，尤其是在美国市场。尽管除了最新的高通芯片之外，三星确实带回了几乎相同的显示器、设计和内部组件，但它确实带来了重大更新:主摄像机现在是一个 200 兆像素的传感器，能够使用 16 合 1 像素的宁滨相机拍摄实际的 200 兆像素或 12.5 兆像素的照片。
