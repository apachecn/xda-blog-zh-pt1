...
> 原文：<https://www.xda-developers.com/clockworkmod-recovery-adapted-for-desire-z/>
...
LiveBoot 是一个独特的引导动画应用程序，它可以在设备启动时向您显示 logcat 和 dmesg 的输出。修改者不仅认为它是比 OEM 徽标更好的启动动画，而且它也很有用，因为它可以在错误发生时向您显示这些日志中的错误。
