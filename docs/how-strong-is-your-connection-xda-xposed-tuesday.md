...
> 原文：<https://www.xda-developers.com/how-strong-is-your-connection-xda-xposed-tuesday/>
...
XDA 资深会员 *Xspeed* 提供的物理按键主控制是一个强大的工具，可以定制您的安卓智能手机上物理按键的行为。通过该模块，您可以禁用原始按钮功能、启动应用程序快捷方式、发送媒体播放信号等。
