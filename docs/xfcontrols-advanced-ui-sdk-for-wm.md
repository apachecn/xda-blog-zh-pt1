...
> 原文：<https://www.xda-developers.com/xfcontrols-advanced-ui-sdk-for-wm/>
...
许多人回忆起 Windows Phone 是一个客观上比 WebOS 和 Blackberry 更好的操作系统，但并没有 Android 或 iOS 那么好……对吧？在我的记忆中，尽管缺少应用程序，Windows Phone 的性能远远优于当时的任何其他操作系统，并且有一个非常出色的用户界面。由于怀旧倾向于扭曲一个人的记忆，我从易贝订购了我的旧 HTC 8X(你可以在亚马逊上买到)，看看用户界面是否真的和我记忆中的一样好。
...
除了用户界面已经老化漂亮，Windows Phone 有惊人的表现在其黄金时期。即使在 2021 年使用 HTC 8X，也没有任何延迟或当机事件表明这款设备已经使用了 10 年。动画是相当顺利的整个最低限度的设计。你在主屏幕上浏览信息和地图的速度，比当时的 iOS 和 Android 都要快得多。
