...
> 原文：<https://www.xda-developers.com/and-so-it-begins-first-development-thread-added-to-windows-8-section-get-the-windows-7-taskbar-back/>
...
三星还改进了外部“覆盖显示”的软件，允许用户在较小的 1.9 英寸显示屏上打开任何应用程序。当然，有些应用在狭小的空间里看起来很傻，但其他应用会从中受益。例如，您可以直接从屏幕外部滚动您的 Spotify 播放列表。
