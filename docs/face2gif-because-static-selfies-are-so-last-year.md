...
> 原文：<https://www.xda-developers.com/face2gif-because-static-selfies-are-so-last-year/>
...
Kindle 以前只是亚马逊的一系列电子阅读器，现在有了一款适用于安卓设备的 Kindle 应用，它可以在没有电子阅读器的情况下提供同样的功能。通过这个应用程序，你可以访问亚马逊庞大的图书、漫画、报纸和杂志库，并可以在任何给定时刻轻松阅读所需内容。如果你更注重听觉而不是阅读，其中一些应用程序还提供了 Audible 旁白，你可以在应用程序中探索多种流派、新版本等。
