...
> 原文：<https://www.xda-developers.com/cant-wait-for-the-official-froyo-upgrade-get-it-now-on-xda/>
...
实际上，这意味着您仍然会收到来自使用 Firebase Cloud Messaging (FCM)的应用程序的推送通知，因为这些通知是通过拥有必要权限的特权 Google Play Services 应用程序发送的。不过，除了少数其他系统应用程序之外，没有其他应用程序可以在后台发送或接收数据。
