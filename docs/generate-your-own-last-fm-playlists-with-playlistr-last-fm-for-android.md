...
> 原文：<https://www.xda-developers.com/generate-your-own-last-fm-playlists-with-playlistr-last-fm-for-android/>
...
谷歌最终通过修改[小部件应用编程接口](https://developer.android.com/guide/topics/appwidgets/overview)来检修安卓上的小部件，以增强不同平台、安卓外壳和发射器的用户体验。我们现在看到了 Google Sans 字体、平面图标和有凝聚力的调色板的一致传播，所有这些一起给了小部件一个更现代的外观。
...
正如你在上面的截图中所看到的，当一个呼叫正在进行，并且用户离开主呼叫屏幕时，Android 12 将在状态栏中显示一个突出的芯片，显示呼叫的持续时间。Android 11 目前不会在状态栏中显示您正在进行的通话时长。要检查呼叫持续时间，您必须返回主呼叫屏幕或下拉通知托盘。
...
这不是手机的功能，而是电视的功能。针对电视的 [Android 12 Beta 3 最重要的新功能是引入了本地 4K 用户界面渲染和动态刷新率切换。](https://www.xda-developers.com/android-12-android-tv-native-4k-refresh-rate/)
